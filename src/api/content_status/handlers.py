...
def handle_content_status(qhit: str) -> Response:
    ...
    tagstore: Tagstore = tagger.tagstore
    track_resolver: TrackResolver = tagger.track_resolver

    batch_ids = tagstore.find_batches(qhit=qhit, author="tagger")
    ...
    payload = ContentStatusResponse(models=model_summaries)
