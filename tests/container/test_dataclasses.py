...
def test_model_tag_hashing():
    tag1 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr")
    tag2 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr")
    tag3 = ModelTag(start_time=1000, end_time=6000, data="world", source_media="media2.mp4", model_track="caption")
...
def test_model_tag_hashing_frameinfo():
    tag1 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr", frame_info={"frame_idx": 10})
    tag2 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr", frame_info={"frame_idx": 10})
    tag3 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr", frame_info={"frame_idx": 10, "box": {"x1": 0.1, "y1": 0.1, "x2": 0.2, "y2": 0.2}})
...
def test_model_tag_complex_hashing():
    ...
    tag3 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr",
                    additional_info={"key2": "value", "key": [1, 2, "arbitrary", {"hey": "a_dict"}]})
    tag4 = ModelTag(start_time=0, end_time=5000, data="hello", source_media="media1.mp4", model_track="asr",
